...
public class veryfunny extends AppCompatActivity {
    RecyclerView recyclerView;
    RecyclerView.Adapter adapter;
    RecyclerView.LayoutManager layoutManager;
    ProgressDialog progressDialog;
    String url1="http://123hindijokes.com/very-funny-jokes/";
    String url2="http://123hindijokes.com/very-funny-jokes/2";
    String url3="http://123hindijokes.com/very-funny-jokes/3";
    String url4="http://123hindijokes.com/very-funny-jokes/4";
    String url5="http://123hindijokes.com/very-funny-jokes/5";
    String url6="http://123hindijokes.com/very-funny-jokes/6";
    String url7="http://123hindijokes.com/very-funny-jokes/7";
    String url8="http://123hindijokes.com/very-funny-jokes/8";
    String url9="http://123hindijokes.com/very-funny-jokes/9";
    String url10="http://123hindijokes.com/very-funny-jokes/10";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fatherson);
        new veryfunny.getJokes().execute();
    ...
    public class getJokes extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog=new ProgressDialog(veryfunny.this);
        ...
        protected void onPostExecute(Void result){
            ...
            recyclerView.addItemDecoration(new SimpleDividerItemDecoration(veryfunny.this));
