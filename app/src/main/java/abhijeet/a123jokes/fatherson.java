...
public class fatherson extends AppCompatActivity {
    RecyclerView recyclerView;
    RecyclerView.Adapter adapter;
    RecyclerView.LayoutManager layoutManager;
    ProgressDialog progressDialog;
    String url1="http://123hindijokes.com/father-son-jokes/";
    String url2="http://123hindijokes.com/father-son-jokes/2";
    String url3="http://123hindijokes.com/father-son-jokes/3";
    @Override
    ...
    public class getJokes extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog=new ProgressDialog(fatherson.this);
        ...
        protected void onPostExecute(Void result){
            ...
            recyclerView.addItemDecoration(new SimpleDividerItemDecoration(fatherson.this));
