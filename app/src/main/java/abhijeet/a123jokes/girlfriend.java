...
public class girlfriend extends AppCompatActivity {
    RecyclerView recyclerView;
    RecyclerView.Adapter adapter;
    RecyclerView.LayoutManager layoutManager;
    ProgressDialog progressDialog;
    String url1="http://123hindijokes.com/girlfriend-boyfriend-jokes/";
    String url2="http://123hindijokes.com/girlfriend-boyfriend-jokes/2";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fatherson);
        new girlfriend.getJokes().execute();
    ...
    public class getJokes extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog=new ProgressDialog(girlfriend.this);
        ...
        protected void onPostExecute(Void result){
            ...
            recyclerView.addItemDecoration(new SimpleDividerItemDecoration(girlfriend.this));
